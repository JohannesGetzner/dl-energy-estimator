...
class TanhDataCollector(DataCollector):
    """
    Data Collector implementation for the Tanh PyTorch module
    """
    def __init__(self,
        ...
        super(TanhDataCollector, self).__init__(
            module_param_configs,
            sampling_timeout,
            sampling_cutoff,
            num_repeat_config,
    ...
    def initialize_module(self, config) -> torch.nn.Module:
        """
        initializes the PyTorch Tanh module
